...
//    ];
    ...
    protected $modelName = '\App\Models\MaterialInspection';
    protected $folderImageName = 'MaterialInspection';
    protected $routes = 'materialInspection';
    protected $FolderBlade = 'materialInspection';
