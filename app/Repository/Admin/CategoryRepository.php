...
use App\Interfaces\Admin\CatergoryRepositoryInterface;
use App\Models\Section;

class CategoryRepository implements CatergoryRepositoryInterface
{


    protected $modelName = '\App\Models\Category';
    protected $folderImageName = 'Category';
    protected $routes = 'category';
    protected $FolderBlade = 'Category';
    ...
    public function index()
    {
        ...
        $section = Section::all();
        return view('Admin/' . $this->FolderBlade . '/' . 'index', compact('data','section'));
    }
