    ...
    <form action="{{route('cashings.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <br>
                @foreach($data->Deletlies as $row)
                    <input type="hidden" name="type_test[]" required value="{{$row}}">
                    <input type="hidden" name="test[]" required value="{{$row}}">
                    <div class="row">
                        <div class="col">
                            <br>
                            <input type="text" value="{{$row->type}}" readonly class="form-control">
                        </div>
                        <br>   <br>
                        <div class="col">
                            <label>وزن الحالي</label>
                            <input type="number" class="form-control"  name="weight">
                        </div>
                        <br>   <br>
                        <div class="col">
                            <label>الكميه الحاليه</label>
                            <input type="number" name="amount" class="form-control ">
                        </div>
                        <br>   <br>
                        <div class="col">
                            <label>خسيه الحاليه</label>
                            <input type="number" class="form-control"  name="testicle" >
                        </div>
                        <br>   <br>
                        <div class="col">
