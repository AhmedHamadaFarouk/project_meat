...
@include('notify')
    ...
    <form action="{{route('meatReceipt.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="number" name="before_receiving" id="id-1" required value="{{old('before_receiving')}}" class="form-control">
                    </div>

                    <div class="col">
                        <label>الوزن بعد الاستلام</label>
                        <input type="number" name="after_receiving" id="id-2" required value="{{old('after_receiving')}}" class="form-control">
                    </div>


                    <div class="col">
                        <label>الخسيه</label>
                        <input type="number" name="jolly" id="id-3" readonly value="{{old('jolly')}}" class="form-control">
                        @error('jolly')
