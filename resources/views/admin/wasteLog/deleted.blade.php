    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">حذف سجل رفع المخلفات</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('wasteLog.destroy', 'test') }}" method="POST" autocomplete="off">
                    @method('DELETE')
                    @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="name_company"
                                ...
                                value="{{ $row->name_company }}" readonly>
                        </div>
                    </div>
