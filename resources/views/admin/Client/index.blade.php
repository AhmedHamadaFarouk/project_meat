@extends('layouts.master') @section('title') الحلال توب فود - اضافه عميل @endsection @section('css') @endsection
@section('page-header')
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    </div> @include('admin.Client.create')
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table text-md-nowrap text-center" id="example1">
                        ...
                        <tbody> @foreach ($data as $row ) <tr>
                                ...
                                </td> @include('admin.Client.edit') @include('admin.Client.deleted')
                            </tr> @endforeach </tbody>
                    </table>
                </div>
            </div>
