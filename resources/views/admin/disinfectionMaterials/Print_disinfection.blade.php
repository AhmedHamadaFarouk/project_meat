...
@endsection
@section('title')
    الحلال توب فود - معاينه طباعة محضر فحص مواد التنظيف و التطهير
@stop
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الاذونات والمحاضر</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    معاينة طباعة محضر فحص مواد التنظيف و التطهير</span>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <h2 class="invoice-title"> محضر فحص مواد التنظيف و التطهير</h2>
