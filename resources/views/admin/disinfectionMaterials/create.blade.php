<!-- Create disinfectionMaterials -->
<div class="modal fade" id="create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> اضافه محضر فحص مواد التنظيف و التطهير   </h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{route('disinfectionMaterials.store')}}" method="POST" autocomplete="off">
                    @csrf
                    {{-- page 419 --}}
