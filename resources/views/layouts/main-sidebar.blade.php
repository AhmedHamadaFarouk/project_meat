...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('adminDashboard') }}"><svg
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('store.index') }}">اضافه مخازن</a></li>
                    ...
                    <li><a class="slide-item" href="{{ route('section.index') }}">اضافه قسم</a></li>
                    <li><a class="slide-item" href="{{ route('category.index') }}">اضافه صنف</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('meatReceipt.index') }}">  مسئول الجوده / استلام  لحوم </a></li>
                <li><a class="slide-item" href="{{ route('meatToxin.index') }}">امين المخزن /  استلام  لحوم </a> </li>
            </ul>
        </li>
        ...
        {{-- <li><a class="slide-item" href="{{ url('/' . $page='form-layouts') }}">Form Layouts</a></li> --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='form-validation') }}">Form
        ...
        {{-- </ul> --}} {{-- </li> --}} {{-- <li class="slide"> --}} {{-- <a class="side-menu__item"
                    data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0V0z" fill="none" />
        ...
        {{-- <ul class="slide-menu"> --}} {{-- <li><a class="slide-item"
                            ...
                            class="slide-item" href="{{ url('/' . $page='table-data') }}">Data Tables</a></li> --}} {{-- </ul> --}}
        {{-- </li> --}} {{-- <li class="slide"> --}} {{-- <a class="side-menu__item"
                    href="{{ url('/' . $page='widgets') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0V0z" fill="none" />
        ...
        </svg><span class="side-menu__label">Widgets</span><span class="badge badge-warning side-badge">Hot</span></a> --}} {{-- </li> --}}
        {{-- <li class="slide"> --}} {{-- <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0V0z" fill="none" />
        ...
        {{-- <ul class="slide-menu"> --}} {{-- <li><a class="slide-item"
                            ...
                            class="slide-item" href="{{ url('/' . $page='map-vector') }}">Vector Maps</a></li> --}} {{-- </ul> --}}
        {{-- </li> --}} {{-- <li class="side-item side-item-category">Pages</li> --}} {{-- <li
                class="slide"> --}} {{-- <a class="side-menu__item" data-toggle="slide"
                    href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24">
            <g>
                <rect fill="none" />
            </g>
            <g>
        ...
        {{-- <ul class="slide-menu"> --}} {{-- <li><a class="slide-item"
                            ...
                            class="slide-item" href="{{ url('/' . $page='invoice') }}">Invoice</a></li> --}}
        {{-- <li><a
                        ...
                        <a class="slide-item" href="{{ url('/' . $page='faq') }}">Faqs</a></li> --}}
        {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='empty') }}">Empty Page</a></li> --}} {{-- </ul> --}} {{-- </li> --}} {{-- <li class="slide"> --}}
        ...
        </svg><span class="side-menu__label">Utilities</span><i class="angle fe fe-chevron-down"></i></a> --}} {{-- <ul class="slide-menu"> --}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='background') }}">Background</a></li> --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='border') }}">Border</a></li> --}}
        {{-- <li><a
                            ...
                            class="slide-item" href="{{ url('/' . $page='margin') }}">Margin</a></li> --}}
        {{-- <li><a
                        ...
                        <a class="slide-item" href="{{ url('/' . $page='width') }}">Width</a></li> --}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='extras') }}">Extras</a></li> --}}
        {{-- </ul> --}}
        ...
        </svg><span class="side-menu__label">Custom Pages</span><i class="angle fe fe-chevron-down"></i></a> --}} {{-- <ul class="slide-menu"> --}}
        {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='signin') }}">Sign In</a></li> --}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='signup') }}">Sign Up</a></li> --}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='forgot') }}">Forgot Password</a></li> --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='reset') }}">Reset Password</a></li> --}}
        {{-- <li><a class="slide-item" href="{{ url('/' . $page='lockscreen') }}">Lockscreen</a></li> --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='underconstruction') }}">UnderConstruction</a>
        </li> --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='404') }}">404 Error</a></li> --}}
        {{-- <li><a class="slide-item" href="{{ url('/' . $page='500') }}">500 Error</a></li> --}} {{-- </ul> --}} {{-- </li> --}} {{-- <li class="slide "> --}}
        {{-- <a class="side-menu__item" data-toggle="slide"
                    href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0V0z" fill="none" />
        ...
        {{-- <ul class="slide-menu"> --}} {{-- <li class="sub-slide"> --}} {{-- <a class="sub-side-menu__item"
                            data-toggle="sub-slide" href="{{ url('/' . $page='#') }}"><span class="sub-side-menu__label">Level1</span><i class="sub-angle fe fe-chevron-down"></i></a> --}} {{-- <ul class="sub-slide-menu"> --}}
