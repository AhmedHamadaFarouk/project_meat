		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ route('adminDashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">الصفحه الرئسيه</span></a>
					</li>
					<li class="side-item side-item-category">الاعدادات العامه</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('branch.index') }}">اضافه الفرع</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">اضافه مخازن</a></li>
							<li><a class="slide-item" href="{{route('supplier.index') }}">اضافه مورد</a></li>
							<li><a class="slide-item" href="{{route('client.index') }}">اضافه عميل</a></li>
							<li><a class="slide-item" href="{{ route('bank.index') }}">اضافه بنك</a></li>
						</ul>
					</li>

					<li class="side-item side-item-category">الاذونات والمحاضر</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">الاذونات والمحاضر</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">اذن إضافة / صرف منتج تام للمخزن</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">محضر فحص و استلام  لحوم</a></li>
...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">الصفحه الرئسيه</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('adminDashboard') }}"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                        <path
                            d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                    </svg><span class="side-menu__label">الصفحه الرئسيه</span></a>
            </li>
            <li class="side-item side-item-category">اعدادات العامه</li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">اضافه الفرع</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">اضافه مخازن</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">اضافه مورد</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">اضافه عميل</a></li>
                    <li><a class="slide-item" href="{{ route('bank.index') }}">اضافه بنك</a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">الاذونات والمحاضر</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
                    ...
                    </svg><span class="side-menu__label">الاذونات والمحاضر</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('products.index') }}">اذن إضافة / صرف منتج تام للمخزن</a>
>>>>>>> 7febc5a16e74b811b8c88fd4dbf177d9d263c5ab
                    </li>
                    <li><a class="slide-item" href="{{ route('examination_receipt.index') }}">محضر فحص و استلام لحوم</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}">امر شغل</a></li>
                    ...
                    <li><a class="slide-item" href="{{  route('disinfectionMaterials.index')}}">امحضر فحص مواد التنظيف و
                            التطهير</a></li>
                    <li><a class="slide-item" href="{{ route('cleaningDisinfection.index') }}">اذن صرف مواد التنظيف و
                            التطهير</a></li>
                    <li><a class="slide-item" href="{{  route('dispensePacking.index') }}">اذن صرف مواد تعبئة و
                            تغليف</a></li>
                    <li><a class="slide-item" href="{{ route('exchangeRawMaterials.index') }}">اذن صرف الخامات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='image-compare') }}">محضر فحص الخامات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='notification') }}">امحضر فحص مواد التنظيف و
                            التطهير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='widget-notification') }}">اذن صرف مواد التنظيف و
                            التطهير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='treeview') }}">اذن صرف مواد تعبئة و تغليف</a>
                    </li>
                </ul>
            </li>
            <li class="side-item side-item-category">المخازن</li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">اضافه موظف</a></li>
                ...
                {{-- <ul class="slide-menu">--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='form-elements') }}">Form Elements</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='form-advanced') }}">Advanced Forms</a></li>--}}
                    ...
                    --}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='form-validation') }}">Form
                            Validation</a></li>--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='form-wizards') }}">Form Wizards</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='form-editor') }}">WYSIWYG Editor</a></li>--}}
                    {{-- </ul>--}} {{-- </li>--}} {{-- <li class="slide">--}} {{-- <a class="side-menu__item"
                ...
                {{-- <ul class="slide-menu">--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='table-basic') }}">Basic Tables</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='table-data') }}">Data Tables</a></li>--}} {{--
                </ul>--}} {{-- </li>--}} {{-- <li class="slide">--}} {{-- <a class="side-menu__item"
                    href="{{ url('/' . $page='widgets') }}"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        class="badge badge-warning side-badge">Hot</span></a>--}} {{-- </li>--}} {{-- <li class="slide">
                --}} {{-- <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
                ...
                {{-- <ul class="slide-menu">--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='map-leaflet') }}">Mapel Maps</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='map-vector') }}">Vector Maps</a></li>--}} {{--
                </ul>--}} {{-- </li>--}} {{-- <li class="side-item side-item-category">Pages</li>--}} {{-- <li
                class="slide">--}} {{-- <a class="side-menu__item" data-toggle="slide"
                ...
                {{-- <ul class="slide-menu">--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='profile') }}">Profile</a></li>--}} {{-- <li><a class="slide-item"
                            href="{{ url('/' . $page='editprofile') }}">Edit-Profile</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='invoice') }}">Invoice</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='pricing') }}">Pricing</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='gallery') }}">Gallery</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='todotask') }}">Todotask</a></li>--}} {{-- <li>
                        <a class="slide-item" href="{{ url('/' . $page='faq') }}">Faqs</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='empty') }}">Empty Page</a></li>--}} {{-- </ul>
                --}} {{-- </li>--}} {{-- <li class="slide">--}} {{-- <a class="side-menu__item" data-toggle="slide"
                    href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                        viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        class="angle fe fe-chevron-down"></i></a>--}} {{-- <ul class="slide-menu">--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='background') }}">Background</a></li>--}} {{--
                    <li><a class="slide-item" href="{{ url('/' . $page='border') }}">Border</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='display') }}">Display</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='flex') }}">Flex</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='height') }}">Height</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='margin') }}">Margin</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='padding') }}">Padding</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='position') }}">Position</a></li>--}} {{-- <li>
                        <a class="slide-item" href="{{ url('/' . $page='width') }}">Width</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='extras') }}">Extras</a></li>--}} {{-- </ul>--}}
                {{-- </li>--}} {{-- <li class="slide">--}} {{-- <a class="side-menu__item" data-toggle="slide"
                    href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                        viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        class="angle fe fe-chevron-down"></i></a>--}} {{-- <ul class="slide-menu">--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='signin') }}">Sign In</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='signup') }}">Sign Up</a></li>--}} {{-- <li><a
                            class="slide-item" href="{{ url('/' . $page='forgot') }}">Forgot Password</a></li>--}} {{--
                    ...
                    </li>--}} {{-- <li><a class="slide-item" href="{{ url('/' . $page='404') }}">404 Error</a></li>--}}
                    {{-- <li><a class="slide-item" href="{{ url('/' . $page='500') }}">500 Error</a></li>--}} {{-- </ul>
                --}} {{-- </li>--}} {{-- <li class="slide ">--}} {{-- <a class="side-menu__item" data-toggle="slide"
                    href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                        viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                {{-- <ul class="slide-menu">--}} {{-- <li class="sub-slide">--}} {{-- <a class="sub-side-menu__item"
                            data-toggle="sub-slide" href="{{ url('/' . $page='#') }}"><span
                                class="sub-side-menu__label">Level1</span><i
                                class="sub-angle fe fe-chevron-down"></i></a>--}} {{-- <ul class="sub-slide-menu">--}}
